...
/**
 * The base implementation of the vcms article local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsArticleLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsArticleLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsArticleLocalServiceUtil
 * @generated
 */
public abstract class VcmsArticleLocalServiceBaseImpl
	implements VcmsArticleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsArticleLocalServiceUtil} to access the vcms article local service.
	 */
	...
	public VcmsArticle addVcmsArticle(VcmsArticle vcmsArticle)
		...
		vcmsArticle = vcmsArticlePersistence.update(vcmsArticle, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsArticle);
			}
	 ...
	 */
	public VcmsArticle createVcmsArticle(String articleId) {
		return vcmsArticlePersistence.create(articleId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsArticle(String articleId)
		throws PortalException, SystemException {
		VcmsArticle vcmsArticle = vcmsArticlePersistence.remove(articleId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsArticle);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsArticle(VcmsArticle vcmsArticle)
		throws SystemException {
		vcmsArticlePersistence.remove(vcmsArticle);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vcmsArticlePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsArticlePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsArticle fetchVcmsArticle(String articleId)
		throws SystemException {
		return vcmsArticlePersistence.fetchByPrimaryKey(articleId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsArticle getVcmsArticle(String articleId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsArticlePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VcmsArticle> getVcmsArticles(int start, int end)
		throws SystemException {
		return vcmsArticlePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsArticlesCount() throws SystemException {
		return vcmsArticlePersistence.countAll();
	}
	...
	public VcmsArticle updateVcmsArticle(VcmsArticle vcmsArticle)
		throws SystemException {
		return updateVcmsArticle(vcmsArticle, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsArticle updateVcmsArticle(VcmsArticle vcmsArticle, boolean merge)
		throws SystemException {
		vcmsArticle.setNew(false);

		vcmsArticle = vcmsArticlePersistence.update(vcmsArticle, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsArticle",
			vcmsArticleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsArticle");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsArticleLocalServiceBaseImpl.class);
