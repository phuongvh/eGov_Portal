...
/**
 * The base implementation of the vcms article version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsArticleVersionLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsArticleVersionLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsArticleVersionLocalServiceUtil
 * @generated
 */
public abstract class VcmsArticleVersionLocalServiceBaseImpl
	implements VcmsArticleVersionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsArticleVersionLocalServiceUtil} to access the vcms article version local service.
	 */
	 ...
	 */
	public VcmsArticleVersion addVcmsArticleVersion(
		VcmsArticleVersion vcmsArticleVersion) throws SystemException {
		vcmsArticleVersion.setNew(true);

		vcmsArticleVersion = vcmsArticleVersionPersistence.update(vcmsArticleVersion,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(vcmsArticleVersion);
			}
	 ...
	 */
	public VcmsArticleVersion createVcmsArticleVersion(long articleVersionId) {
		return vcmsArticleVersionPersistence.create(articleVersionId);
	}
	...
	public void deleteVcmsArticleVersion(long articleVersionId)
		...
		VcmsArticleVersion vcmsArticleVersion = vcmsArticleVersionPersistence.remove(articleVersionId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsArticleVersion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsArticleVersion(VcmsArticleVersion vcmsArticleVersion)
		throws SystemException {
		vcmsArticleVersionPersistence.remove(vcmsArticleVersion);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsArticleVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsArticleVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsArticleVersion fetchVcmsArticleVersion(long articleVersionId)
		throws SystemException {
		return vcmsArticleVersionPersistence.fetchByPrimaryKey(articleVersionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsArticleVersion getVcmsArticleVersion(long articleVersionId)
		throws PortalException, SystemException {
		return vcmsArticleVersionPersistence.findByPrimaryKey(articleVersionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsArticleVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsArticleVersion> getVcmsArticleVersions(int start, int end)
		throws SystemException {
		return vcmsArticleVersionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsArticleVersionsCount() throws SystemException {
		return vcmsArticleVersionPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsArticleVersion updateVcmsArticleVersion(
		VcmsArticleVersion vcmsArticleVersion) throws SystemException {
		return updateVcmsArticleVersion(vcmsArticleVersion, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsArticleVersion",
			vcmsArticleVersionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsArticleVersion");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsArticleVersionLocalServiceBaseImpl.class);
