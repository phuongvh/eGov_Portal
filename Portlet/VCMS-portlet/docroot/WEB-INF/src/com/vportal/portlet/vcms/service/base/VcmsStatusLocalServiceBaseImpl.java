...
public abstract class VcmsStatusLocalServiceBaseImpl
	implements VcmsStatusLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public VcmsStatus addVcmsStatus(VcmsStatus vcmsStatus)
		...
		vcmsStatus = vcmsStatusPersistence.update(vcmsStatus, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsStatus);
			}
	...
	public void deleteVcmsStatus(long statusId)
		...
		VcmsStatus vcmsStatus = vcmsStatusPersistence.remove(statusId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsStatus);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public VcmsStatus fetchVcmsStatus(long statusId) throws SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public VcmsStatus updateVcmsStatus(VcmsStatus vcmsStatus)
		throws SystemException {
		return updateVcmsStatus(vcmsStatus, true);
	}
	...
	public VcmsStatus updateVcmsStatus(VcmsStatus vcmsStatus, boolean merge)
		...
		vcmsStatus = vcmsStatusPersistence.update(vcmsStatus, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsStatus",
			vcmsStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsStatus");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsStatusLocalServiceBaseImpl.class);
