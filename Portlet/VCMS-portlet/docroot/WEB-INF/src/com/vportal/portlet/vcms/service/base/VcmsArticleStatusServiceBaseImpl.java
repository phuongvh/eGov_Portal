...
/**
 * The base implementation of the vcms article status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsArticleStatusServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsArticleStatusServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsArticleStatusServiceUtil
 * @generated
 */
public abstract class VcmsArticleStatusServiceBaseImpl extends PrincipalBean
	implements VcmsArticleStatusService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsArticleStatusServiceUtil} to access the vcms article status remote service.
	 */
