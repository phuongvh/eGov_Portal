...
public abstract class VcmsArticleStatusLocalServiceBaseImpl
	implements VcmsArticleStatusLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public VcmsArticleStatus addVcmsArticleStatus(
		...
		vcmsArticleStatus = vcmsArticleStatusPersistence.update(vcmsArticleStatus,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(vcmsArticleStatus);
			}
	...
	public void deleteVcmsArticleStatus(long id)
		...
		VcmsArticleStatus vcmsArticleStatus = vcmsArticleStatusPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsArticleStatus);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public VcmsArticleStatus fetchVcmsArticleStatus(long id)
		throws SystemException {
		return vcmsArticleStatusPersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsArticleStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public VcmsArticleStatus updateVcmsArticleStatus(
		VcmsArticleStatus vcmsArticleStatus) throws SystemException {
		return updateVcmsArticleStatus(vcmsArticleStatus, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsArticleStatus",
			vcmsArticleStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsArticleStatus");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsArticleStatusLocalServiceBaseImpl.class);
