...
/**
 * The base implementation of the vcms t a relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsTARelationLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsTARelationLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsTARelationLocalServiceUtil
 * @generated
 */
public abstract class VcmsTARelationLocalServiceBaseImpl
	implements VcmsTARelationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsTARelationLocalServiceUtil} to access the vcms t a relation local service.
	 */
	 ...
	 */
	public VcmsTARelation addVcmsTARelation(VcmsTARelation vcmsTARelation)
		throws SystemException {
		vcmsTARelation.setNew(true);

		vcmsTARelation = vcmsTARelationPersistence.update(vcmsTARelation, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsTARelation);
			}
	 ...
	 */
	public VcmsTARelation createVcmsTARelation(
		VcmsTARelationPK vcmsTARelationPK) {
		return vcmsTARelationPersistence.create(vcmsTARelationPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsTARelation(VcmsTARelationPK vcmsTARelationPK)
		throws PortalException, SystemException {
		VcmsTARelation vcmsTARelation = vcmsTARelationPersistence.remove(vcmsTARelationPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsTARelation);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsTARelation(VcmsTARelation vcmsTARelation)
		throws SystemException {
		vcmsTARelationPersistence.remove(vcmsTARelation);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsTARelationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsTARelationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsTARelation fetchVcmsTARelation(VcmsTARelationPK vcmsTARelationPK)
		throws SystemException {
		return vcmsTARelationPersistence.fetchByPrimaryKey(vcmsTARelationPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsTARelation getVcmsTARelation(VcmsTARelationPK vcmsTARelationPK)
		throws PortalException, SystemException {
		return vcmsTARelationPersistence.findByPrimaryKey(vcmsTARelationPK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsTARelationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsTARelation> getVcmsTARelations(int start, int end)
		throws SystemException {
		return vcmsTARelationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsTARelationsCount() throws SystemException {
		return vcmsTARelationPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsTARelation updateVcmsTARelation(VcmsTARelation vcmsTARelation)
		throws SystemException {
		return updateVcmsTARelation(vcmsTARelation, true);
	}
	...
	public VcmsTARelation updateVcmsTARelation(VcmsTARelation vcmsTARelation,
		...
		vcmsTARelation = vcmsTARelationPersistence.update(vcmsTARelation, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsTARelation",
			vcmsTARelationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsTARelation");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsTARelationLocalServiceBaseImpl.class);
