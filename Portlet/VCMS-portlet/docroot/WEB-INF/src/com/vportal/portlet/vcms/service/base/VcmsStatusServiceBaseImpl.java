...
/**
 * The base implementation of the vcms status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsStatusServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsStatusServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsStatusServiceUtil
 * @generated
 */
public abstract class VcmsStatusServiceBaseImpl extends PrincipalBean
	implements VcmsStatusService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsStatusServiceUtil} to access the vcms status remote service.
	 */
