...
/**
 * The base implementation of the vcms type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsTypeLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsTypeLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsTypeLocalServiceUtil
 * @generated
 */
public abstract class VcmsTypeLocalServiceBaseImpl
	implements VcmsTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsTypeLocalServiceUtil} to access the vcms type local service.
	 */
	 ...
	 */
	public VcmsType addVcmsType(VcmsType vcmsType) throws SystemException {
		vcmsType.setNew(true);

		vcmsType = vcmsTypePersistence.update(vcmsType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsType);
			}
	 ...
	 */
	public VcmsType createVcmsType(String typeId) {
		return vcmsTypePersistence.create(typeId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsType(String typeId)
		throws PortalException, SystemException {
		VcmsType vcmsType = vcmsTypePersistence.remove(typeId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsType(VcmsType vcmsType) throws SystemException {
		vcmsTypePersistence.remove(vcmsType);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vcmsTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vcmsTypePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vcmsTypePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsType fetchVcmsType(String typeId) throws SystemException {
		return vcmsTypePersistence.fetchByPrimaryKey(typeId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsType getVcmsType(String typeId)
		throws PortalException, SystemException {
		return vcmsTypePersistence.findByPrimaryKey(typeId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsType> getVcmsTypes(int start, int end)
		throws SystemException {
		return vcmsTypePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsTypesCount() throws SystemException {
		return vcmsTypePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsType updateVcmsType(VcmsType vcmsType) throws SystemException {
		return updateVcmsType(vcmsType, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsType updateVcmsType(VcmsType vcmsType, boolean merge)
		throws SystemException {
		vcmsType.setNew(false);

		vcmsType = vcmsTypePersistence.update(vcmsType, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsType",
			vcmsTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsType");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsTypeLocalServiceBaseImpl.class);
