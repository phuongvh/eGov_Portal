...
/**
 * The base implementation of the vcms discussion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsDiscussionLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsDiscussionLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsDiscussionLocalServiceUtil
 * @generated
 */
public abstract class VcmsDiscussionLocalServiceBaseImpl
	implements VcmsDiscussionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsDiscussionLocalServiceUtil} to access the vcms discussion local service.
	 */
	...
	public VcmsDiscussion addVcmsDiscussion(VcmsDiscussion vcmsDiscussion)
		...
		vcmsDiscussion = vcmsDiscussionPersistence.update(vcmsDiscussion, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsDiscussion);
			}
	 ...
	 */
	public VcmsDiscussion createVcmsDiscussion(String discussionId) {
		return vcmsDiscussionPersistence.create(discussionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsDiscussion(String discussionId)
		throws PortalException, SystemException {
		VcmsDiscussion vcmsDiscussion = vcmsDiscussionPersistence.remove(discussionId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsDiscussion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsDiscussion(VcmsDiscussion vcmsDiscussion)
		throws SystemException {
		vcmsDiscussionPersistence.remove(vcmsDiscussion);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsDiscussionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsDiscussionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsDiscussion fetchVcmsDiscussion(String discussionId)
		throws SystemException {
		return vcmsDiscussionPersistence.fetchByPrimaryKey(discussionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsDiscussion getVcmsDiscussion(String discussionId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsDiscussionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VcmsDiscussion> getVcmsDiscussions(int start, int end)
		throws SystemException {
		return vcmsDiscussionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsDiscussionsCount() throws SystemException {
		return vcmsDiscussionPersistence.countAll();
	}
	...
	public VcmsDiscussion updateVcmsDiscussion(VcmsDiscussion vcmsDiscussion)
		throws SystemException {
		return updateVcmsDiscussion(vcmsDiscussion, true);
	}
	...
	public VcmsDiscussion updateVcmsDiscussion(VcmsDiscussion vcmsDiscussion,
		...
		vcmsDiscussion = vcmsDiscussionPersistence.update(vcmsDiscussion, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsDiscussion",
			vcmsDiscussionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsDiscussion");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsDiscussionLocalServiceBaseImpl.class);
