...
/**
 * The base implementation of the vcms portion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsPortionLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsPortionLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsPortionLocalServiceUtil
 * @generated
 */
public abstract class VcmsPortionLocalServiceBaseImpl
	implements VcmsPortionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsPortionLocalServiceUtil} to access the vcms portion local service.
	 */
	 ...
	 */
	public VcmsPortion addVcmsPortion(VcmsPortion vcmsPortion)
		throws SystemException {
		vcmsPortion.setNew(true);

		vcmsPortion = vcmsPortionPersistence.update(vcmsPortion, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsPortion);
			}
	 ...
	 */
	public VcmsPortion createVcmsPortion(String portionId) {
		return vcmsPortionPersistence.create(portionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsPortion(String portionId)
		throws PortalException, SystemException {
		VcmsPortion vcmsPortion = vcmsPortionPersistence.remove(portionId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsPortion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsPortion(VcmsPortion vcmsPortion)
		throws SystemException {
		vcmsPortionPersistence.remove(vcmsPortion);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsPortionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vcmsPortionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsPortionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsPortion fetchVcmsPortion(String portionId)
		throws SystemException {
		return vcmsPortionPersistence.fetchByPrimaryKey(portionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsPortion getVcmsPortion(String portionId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsPortionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsPortion> getVcmsPortions(int start, int end)
		throws SystemException {
		return vcmsPortionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsPortionsCount() throws SystemException {
		return vcmsPortionPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsPortion updateVcmsPortion(VcmsPortion vcmsPortion)
		throws SystemException {
		return updateVcmsPortion(vcmsPortion, true);
	}
	 ...
	 *
	 * @param vcmsPortion the vcms portion
	 * @param merge whether to merge the vcms portion with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the vcms portion that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsPortion updateVcmsPortion(VcmsPortion vcmsPortion, boolean merge)
		throws SystemException {
		vcmsPortion.setNew(false);

		vcmsPortion = vcmsPortionPersistence.update(vcmsPortion, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsPortion",
			vcmsPortionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsPortion");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsPortionLocalServiceBaseImpl.class);
