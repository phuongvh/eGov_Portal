...
/**
 * The base implementation of the vcms category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsCategoryLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsCategoryLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsCategoryLocalServiceUtil
 * @generated
 */
public abstract class VcmsCategoryLocalServiceBaseImpl
	implements VcmsCategoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsCategoryLocalServiceUtil} to access the vcms category local service.
	 */
	...
	public VcmsCategory addVcmsCategory(VcmsCategory vcmsCategory)
		...
		vcmsCategory = vcmsCategoryPersistence.update(vcmsCategory, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsCategory);
			}
	 ...
	 */
	public VcmsCategory createVcmsCategory(String categoryId) {
		return vcmsCategoryPersistence.create(categoryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsCategory(String categoryId)
		throws PortalException, SystemException {
		VcmsCategory vcmsCategory = vcmsCategoryPersistence.remove(categoryId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsCategory);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsCategory(VcmsCategory vcmsCategory)
		throws SystemException {
		vcmsCategoryPersistence.remove(vcmsCategory);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsCategory fetchVcmsCategory(String categoryId)
		throws SystemException {
		return vcmsCategoryPersistence.fetchByPrimaryKey(categoryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsCategory getVcmsCategory(String categoryId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VcmsCategory> getVcmsCategories(int start, int end)
		throws SystemException {
		return vcmsCategoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsCategoriesCount() throws SystemException {
		return vcmsCategoryPersistence.countAll();
	}
	...
	public VcmsCategory updateVcmsCategory(VcmsCategory vcmsCategory)
		throws SystemException {
		return updateVcmsCategory(vcmsCategory, true);
	}
	...
	public VcmsCategory updateVcmsCategory(VcmsCategory vcmsCategory,
		...
		vcmsCategory = vcmsCategoryPersistence.update(vcmsCategory, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsCategory",
			vcmsCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsCategory");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsCategoryLocalServiceBaseImpl.class);
