...
/**
 * The base implementation of the vcms thread local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsThreadLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsThreadLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsThreadLocalServiceUtil
 * @generated
 */
public abstract class VcmsThreadLocalServiceBaseImpl
	implements VcmsThreadLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsThreadLocalServiceUtil} to access the vcms thread local service.
	 */
	 ...
	 */
	public VcmsThread addVcmsThread(VcmsThread vcmsThread)
		throws SystemException {
		vcmsThread.setNew(true);

		vcmsThread = vcmsThreadPersistence.update(vcmsThread, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsThread);
			}
	 ...
	 */
	public VcmsThread createVcmsThread(String threadId) {
		return vcmsThreadPersistence.create(threadId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsThread(String threadId)
		throws PortalException, SystemException {
		VcmsThread vcmsThread = vcmsThreadPersistence.remove(threadId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsThread);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsThread(VcmsThread vcmsThread)
		throws SystemException {
		vcmsThreadPersistence.remove(vcmsThread);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsThreadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vcmsThreadPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsThreadPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsThread fetchVcmsThread(String threadId)
		throws SystemException {
		return vcmsThreadPersistence.fetchByPrimaryKey(threadId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsThread getVcmsThread(String threadId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsThreadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsThread> getVcmsThreads(int start, int end)
		throws SystemException {
		return vcmsThreadPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsThreadsCount() throws SystemException {
		return vcmsThreadPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsThread updateVcmsThread(VcmsThread vcmsThread)
		throws SystemException {
		return updateVcmsThread(vcmsThread, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsThread updateVcmsThread(VcmsThread vcmsThread, boolean merge)
		throws SystemException {
		vcmsThread.setNew(false);

		vcmsThread = vcmsThreadPersistence.update(vcmsThread, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsThread",
			vcmsThreadLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsThread");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsThreadLocalServiceBaseImpl.class);
