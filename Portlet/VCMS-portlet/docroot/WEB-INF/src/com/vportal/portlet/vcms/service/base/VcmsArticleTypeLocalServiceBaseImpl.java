...
public abstract class VcmsArticleTypeLocalServiceBaseImpl
	implements VcmsArticleTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public VcmsArticleType addVcmsArticleType(VcmsArticleType vcmsArticleType)
		...
		vcmsArticleType = vcmsArticleTypePersistence.update(vcmsArticleType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(vcmsArticleType);
			}
	...
	public void deleteVcmsArticleType(VcmsArticleTypePK vcmsArticleTypePK)
		...
		VcmsArticleType vcmsArticleType = vcmsArticleTypePersistence.remove(vcmsArticleTypePK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsArticleType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public VcmsArticleType fetchVcmsArticleType(
		...
		return vcmsArticleTypePersistence.fetchByPrimaryKey(vcmsArticleTypePK);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsArticleTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public VcmsArticleType updateVcmsArticleType(
		...
		return updateVcmsArticleType(vcmsArticleType, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsArticleType",
			vcmsArticleTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsArticleType");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsArticleTypeLocalServiceBaseImpl.class);
