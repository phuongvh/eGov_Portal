...
/**
 * The base implementation of the vcms c a relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsCARelationLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsCARelationLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsCARelationLocalServiceUtil
 * @generated
 */
public abstract class VcmsCARelationLocalServiceBaseImpl
	implements VcmsCARelationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsCARelationLocalServiceUtil} to access the vcms c a relation local service.
	 */
	...
	public VcmsCARelation addVcmsCARelation(VcmsCARelation vcmsCARelation)
		...
		vcmsCARelation = vcmsCARelationPersistence.update(vcmsCARelation, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsCARelation);
			}
	...
	public VcmsCARelation createVcmsCARelation(
		...
		return vcmsCARelationPersistence.create(vcmsCARelationPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsCARelation(VcmsCARelationPK vcmsCARelationPK)
		throws PortalException, SystemException {
		VcmsCARelation vcmsCARelation = vcmsCARelationPersistence.remove(vcmsCARelationPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsCARelation);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsCARelation(VcmsCARelation vcmsCARelation)
		throws SystemException {
		vcmsCARelationPersistence.remove(vcmsCARelation);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsCARelationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsCARelationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsCARelation fetchVcmsCARelation(VcmsCARelationPK vcmsCARelationPK)
		throws SystemException {
		return vcmsCARelationPersistence.fetchByPrimaryKey(vcmsCARelationPK);
	}
	...
	public VcmsCARelation getVcmsCARelation(VcmsCARelationPK vcmsCARelationPK)
		throws PortalException, SystemException {
		return vcmsCARelationPersistence.findByPrimaryKey(vcmsCARelationPK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsCARelationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VcmsCARelation> getVcmsCARelations(int start, int end)
		throws SystemException {
		return vcmsCARelationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsCARelationsCount() throws SystemException {
		return vcmsCARelationPersistence.countAll();
	}
	...
	public VcmsCARelation updateVcmsCARelation(VcmsCARelation vcmsCARelation)
		throws SystemException {
		return updateVcmsCARelation(vcmsCARelation, true);
	}
	...
	public VcmsCARelation updateVcmsCARelation(VcmsCARelation vcmsCARelation,
		...
		vcmsCARelation = vcmsCARelationPersistence.update(vcmsCARelation, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsCARelation",
			vcmsCARelationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsCARelation");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsCARelationLocalServiceBaseImpl.class);
