...
/**
 * The base implementation of the vcms p a relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsPARelationLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsPARelationLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsPARelationLocalServiceUtil
 * @generated
 */
public abstract class VcmsPARelationLocalServiceBaseImpl
	implements VcmsPARelationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsPARelationLocalServiceUtil} to access the vcms p a relation local service.
	 */
	 ...
	 */
	public VcmsPARelation addVcmsPARelation(VcmsPARelation vcmsPARelation)
		throws SystemException {
		vcmsPARelation.setNew(true);

		vcmsPARelation = vcmsPARelationPersistence.update(vcmsPARelation, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vcmsPARelation);
			}
	 ...
	 */
	public VcmsPARelation createVcmsPARelation(
		VcmsPARelationPK vcmsPARelationPK) {
		return vcmsPARelationPersistence.create(vcmsPARelationPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsPARelation(VcmsPARelationPK vcmsPARelationPK)
		throws PortalException, SystemException {
		VcmsPARelation vcmsPARelation = vcmsPARelationPersistence.remove(vcmsPARelationPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsPARelation);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsPARelation(VcmsPARelation vcmsPARelation)
		throws SystemException {
		vcmsPARelationPersistence.remove(vcmsPARelation);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsPARelationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsPARelationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsPARelation fetchVcmsPARelation(VcmsPARelationPK vcmsPARelationPK)
		throws SystemException {
		return vcmsPARelationPersistence.fetchByPrimaryKey(vcmsPARelationPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsPARelation getVcmsPARelation(VcmsPARelationPK vcmsPARelationPK)
		throws PortalException, SystemException {
		return vcmsPARelationPersistence.findByPrimaryKey(vcmsPARelationPK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsPARelationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsPARelation> getVcmsPARelations(int start, int end)
		throws SystemException {
		return vcmsPARelationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsPARelationsCount() throws SystemException {
		return vcmsPARelationPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsPARelation updateVcmsPARelation(VcmsPARelation vcmsPARelation)
		throws SystemException {
		return updateVcmsPARelation(vcmsPARelation, true);
	}
	...
	public VcmsPARelation updateVcmsPARelation(VcmsPARelation vcmsPARelation,
		...
		vcmsPARelation = vcmsPARelationPersistence.update(vcmsPARelation, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsPARelation",
			vcmsPARelationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsPARelation");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsPARelationLocalServiceBaseImpl.class);
