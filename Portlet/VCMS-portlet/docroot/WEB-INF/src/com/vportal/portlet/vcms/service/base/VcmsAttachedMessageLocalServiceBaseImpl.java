...
/**
 * The base implementation of the vcms attached message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vcms.service.impl.VcmsAttachedMessageLocalServiceImpl}.
 * </p>
 *
 * @author hai
 * @see com.vportal.portlet.vcms.service.impl.VcmsAttachedMessageLocalServiceImpl
 * @see com.vportal.portlet.vcms.service.VcmsAttachedMessageLocalServiceUtil
 * @generated
 */
public abstract class VcmsAttachedMessageLocalServiceBaseImpl
	implements VcmsAttachedMessageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vcms.service.VcmsAttachedMessageLocalServiceUtil} to access the vcms attached message local service.
	 */
	 ...
	 */
	public VcmsAttachedMessage addVcmsAttachedMessage(
		VcmsAttachedMessage vcmsAttachedMessage) throws SystemException {
		vcmsAttachedMessage.setNew(true);

		vcmsAttachedMessage = vcmsAttachedMessagePersistence.update(vcmsAttachedMessage,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(vcmsAttachedMessage);
			}
	 ...
	 */
	public VcmsAttachedMessage createVcmsAttachedMessage(String messageId) {
		return vcmsAttachedMessagePersistence.create(messageId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVcmsAttachedMessage(String messageId)
		throws PortalException, SystemException {
		VcmsAttachedMessage vcmsAttachedMessage = vcmsAttachedMessagePersistence.remove(messageId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(vcmsAttachedMessage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteVcmsAttachedMessage(
		VcmsAttachedMessage vcmsAttachedMessage) throws SystemException {
		vcmsAttachedMessagePersistence.remove(vcmsAttachedMessage);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vcmsAttachedMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vcmsAttachedMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VcmsAttachedMessage fetchVcmsAttachedMessage(String messageId)
		throws SystemException {
		return vcmsAttachedMessagePersistence.fetchByPrimaryKey(messageId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsAttachedMessage getVcmsAttachedMessage(String messageId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vcmsAttachedMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VcmsAttachedMessage> getVcmsAttachedMessages(int start, int end)
		throws SystemException {
		return vcmsAttachedMessagePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVcmsAttachedMessagesCount() throws SystemException {
		return vcmsAttachedMessagePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsAttachedMessage updateVcmsAttachedMessage(
		VcmsAttachedMessage vcmsAttachedMessage) throws SystemException {
		return updateVcmsAttachedMessage(vcmsAttachedMessage, true);
	}
	 ...
	 *
	 * @param vcmsAttachedMessage the vcms attached message
	 * @param merge whether to merge the vcms attached message with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the vcms attached message that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public VcmsAttachedMessage updateVcmsAttachedMessage(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcms.model.VcmsAttachedMessage",
			vcmsAttachedMessageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcms.model.VcmsAttachedMessage");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VcmsAttachedMessageLocalServiceBaseImpl.class);
