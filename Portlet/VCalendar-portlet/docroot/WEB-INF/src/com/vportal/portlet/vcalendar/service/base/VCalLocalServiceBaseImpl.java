...
public abstract class VCalLocalServiceBaseImpl implements VCalLocalService,
	...
	public VCal addVCal(VCal vCal) throws SystemException {
		...
		vCal = vCalPersistence.update(vCal, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(vCal);
			}
	...
	public void deleteVCal(long calId) throws PortalException, SystemException {
		VCal vCal = vCalPersistence.remove(calId);
	...
	public VCal fetchVCal(long calId) throws SystemException {
		return vCalPersistence.fetchByPrimaryKey(calId);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return vCalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public VCal updateVCal(VCal vCal, boolean merge) throws SystemException {
		...
		vCal = vCalPersistence.update(vCal, merge);
	...
	/**
	 * Returns the v cal local service.
	 *
	...
	/**
	 * Returns the v cal remote service.
	 *
	...
	/**
	 * Returns the v file remote service.
	 *
	...
	/**
	 * Returns the v file persistence.
	 *
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vcalendar.model.VCal",
			vCalLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vcalendar.model.VCal");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VCalLocalServiceBaseImpl.class);
