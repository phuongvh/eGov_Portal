...
public class VFileServiceSoap {
	...
	public static com.vportal.portlet.vcalendar.model.VFile[] findByAll()
		throws RemoteException {
		try {
			java.util.List<com.vportal.portlet.vcalendar.model.VFile> returnValue =
				VFileServiceUtil.findByAll();

			return returnValue.toArray(new com.vportal.portlet.vcalendar.model.VFile[returnValue.size()]);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.vportal.portlet.vcalendar.model.VFile[] findByAll(
		...
		try {
			java.util.List<com.vportal.portlet.vcalendar.model.VFile> returnValue =
				VFileServiceUtil.findByAll(begin, end);
	...
	public static com.vportal.portlet.vcalendar.model.VFile[] findByGroupId(
		int status) throws RemoteException {
		try {
			java.util.List<com.vportal.portlet.vcalendar.model.VFile> returnValue =
				VFileServiceUtil.findByGroupId(status);
	...
	public static com.vportal.portlet.vcalendar.model.VFile[] findByGroupId(
		...
		try {
			java.util.List<com.vportal.portlet.vcalendar.model.VFile> returnValue =
				VFileServiceUtil.findByGroupId(status, begin, end);
