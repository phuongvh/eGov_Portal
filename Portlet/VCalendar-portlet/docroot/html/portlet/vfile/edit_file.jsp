...
<%-- 			alert("<%= LanguageUtil.get(pageContext, "pVfile.form.invalidPhone") %>"); --%>
...
<tr>
    <td>
    	<liferay-ui:message key="vfile.birthday" />		
	</td>
	<td>
...
<tr>
	<td>
		<liferay-ui:message key="vfile.address" />			
	</td>
	<td>
...
<tr>
	<td>
		<liferay-ui:message key="vfile.phone" />			
	</td>
	<td>
...
<tr>
	<td>
		<liferay-ui:message key="vfile.position" />			
	</td>
	<td>
