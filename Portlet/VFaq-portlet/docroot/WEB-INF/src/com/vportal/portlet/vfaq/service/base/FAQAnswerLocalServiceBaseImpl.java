...
public abstract class FAQAnswerLocalServiceBaseImpl
	implements FAQAnswerLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public FAQAnswer addFAQAnswer(FAQAnswer faqAnswer)
		...
		faqAnswer = faqAnswerPersistence.update(faqAnswer, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(faqAnswer);
			}
	...
	public void deleteFAQAnswer(long id)
		...
		FAQAnswer faqAnswer = faqAnswerPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(faqAnswer);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public FAQAnswer fetchFAQAnswer(long id) throws SystemException {
		return faqAnswerPersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return faqAnswerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public FAQAnswer updateFAQAnswer(FAQAnswer faqAnswer)
		throws SystemException {
		return updateFAQAnswer(faqAnswer, true);
	}
	...
	public FAQAnswer updateFAQAnswer(FAQAnswer faqAnswer, boolean merge)
		...
		faqAnswer = faqAnswerPersistence.update(faqAnswer, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vfaq.model.FAQAnswer",
			faqAnswerLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vfaq.model.FAQAnswer");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(FAQAnswerLocalServiceBaseImpl.class);
