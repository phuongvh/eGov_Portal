...
package com.vportal.portlet.vfaqmenu.action;
...
import com.vportal.portlet.vfaq.util.LayoutPortletUtil;
/**
...
public class ViewAction extends MVCPortlet {
	...
	public void render(RenderRequest req, RenderResponse res)
		...
		try {
			LayoutPortletUtil.getLayoutPortletIds(selectLayouts, req,"vfaqcontent_WAR_VFaqportlet_INSTANCE_");
	...
	public void selectLayoutPortlet(PortletRequest req,ActionResponse res) throws Exception {
		...
		LayoutPortletUtil.getLayoutPortletIds(selectLayouts, req,
				"vfaqcontent_WAR_VFaqportlet_INSTANCE_");
