...
public abstract class FAQCategoryLocalServiceBaseImpl
	implements FAQCategoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public FAQCategory addFAQCategory(FAQCategory faqCategory)
		...
		faqCategory = faqCategoryPersistence.update(faqCategory, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(faqCategory);
			}
	...
	public void deleteFAQCategory(long id)
		...
		FAQCategory faqCategory = faqCategoryPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(faqCategory);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public FAQCategory fetchFAQCategory(long id) throws SystemException {
		return faqCategoryPersistence.fetchByPrimaryKey(id);
	}
	...
	public FAQCategory updateFAQCategory(FAQCategory faqCategory)
		throws SystemException {
		return updateFAQCategory(faqCategory, true);
	}
	...
	public FAQCategory updateFAQCategory(FAQCategory faqCategory, boolean merge)
		...
		faqCategory = faqCategoryPersistence.update(faqCategory, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vfaq.model.FAQCategory",
			faqCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vfaq.model.FAQCategory");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(FAQCategoryLocalServiceBaseImpl.class);
