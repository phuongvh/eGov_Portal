...
public class TFCategoryPersistenceImpl extends BasePersistenceImpl<TFCategory>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			TFCategoryModelImpl.FINDER_CACHE_ENABLED, TFCategoryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			TFCategoryModelImpl.FINDER_CACHE_ENABLED, TFCategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroupId",
			new String[] { Long.class.getName() },
			TFCategoryModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			TFCategoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			TFCategoryModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			TFCategoryModelImpl.FINDER_CACHE_ENABLED, TFCategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
			TFCategoryModelImpl.FINDER_CACHE_ENABLED, TFCategoryImpl.class,
	...
	public void cacheResult(TFCategory tfCategory) {
		...
		tfCategory.resetOriginalValues();
	}
	...
	public void cacheResult(List<TFCategory> tfCategories) {
		for (TFCategory tfCategory : tfCategories) {
			if (EntityCacheUtil.getResult(
						...
						TFCategoryImpl.class, tfCategory.getPrimaryKey()) == null) {
	...
	@Override
	public void clearCache(List<TFCategory> tfCategories) {
		FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
	 ...
	 * Removes the t f category with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the t f category
	 * @return the t f category that was removed
	 * @throws com.vportal.portlet.vimagegallery.NoSuchTFCategoryException if a t f category with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public TFCategory updateImpl(
		...
		boolean isNew = tfCategory.isNew();

		TFCategoryModelImpl tfCategoryModelImpl = (TFCategoryModelImpl)tfCategory;
		...
		if (isNew || !TFCategoryModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}

		else {
			if ((tfCategoryModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(tfCategoryModelImpl.getOriginalGroupId())
					};
				...
				args = new Object[] {
						Long.valueOf(tfCategoryModelImpl.getGroupId())
					};
			...
			if ((tfCategoryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tfCategoryModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(tfCategoryModelImpl.getCompanyId())
					};
	...
	/**
	 * Returns the t f category with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the t f category
	...
	public TFCategory fetchByPrimaryKey(long id) throws SystemException {
		TFCategory tfCategory = (TFCategory)EntityCacheUtil.getResult(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
				TFCategoryImpl.class, id);

		if (tfCategory == _nullTFCategory) {
			return null;
		}
		...
		if (tfCategory == null) {
			...
			try {
				...
				if (tfCategory != null) {
					...
					EntityCacheUtil.putResult(TFCategoryModelImpl.ENTITY_CACHE_ENABLED,
						TFCategoryImpl.class, id, _nullTFCategory);
				}
	...
	public List<TFCategory> findByGroupId(long groupId, int start, int end,
		...
		List<TFCategory> list = (List<TFCategory>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);
	...
	protected TFCategory getByGroupId_PrevAndNext(Session session,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(tfCategory);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TFCategory[] filterFindByGroupId_PrevAndNext(long id, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchTFCategoryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, tfCategory,
					groupId, orderByComparator, true);

			array[1] = tfCategory;

			array[2] = filterGetByGroupId_PrevAndNext(session, tfCategory,
	...
	protected TFCategory filterGetByGroupId_PrevAndNext(Session session,
		TFCategory tfCategory, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "tfCategory.id_";
	...
	private static final String _FILTER_SQL_SELECT_TFCATEGORY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {TFCategory.*} FROM (SELECT DISTINCT tfCategory.id_ FROM TFCategory tfCategory WHERE ";
	private static final String _FILTER_SQL_SELECT_TFCATEGORY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN TFCategory ON TEMP_TABLE.id_ = TFCategory.id_";
	private static final String _FILTER_SQL_COUNT_TFCATEGORY_WHERE = "SELECT COUNT(DISTINCT tfCategory.id_) AS COUNT_VALUE FROM TFCategory tfCategory WHERE ";
	...
	private static TFCategory _nullTFCategory = new TFCategoryImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<TFCategory> toCacheModel() {
				return _nullTFCategoryCacheModel;
			}
		};

	private static CacheModel<TFCategory> _nullTFCategoryCacheModel = new CacheModel<TFCategory>() {
			public TFCategory toEntityModel() {
				return _nullTFCategory;
			}
		};
}