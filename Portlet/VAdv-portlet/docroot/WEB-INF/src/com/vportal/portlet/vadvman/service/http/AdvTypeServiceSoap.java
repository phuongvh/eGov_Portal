...
public class AdvTypeServiceSoap {
	...
	public static com.vportal.portlet.vadvman.model.AdvType[] getTypeByG(
		long groupId) throws RemoteException {
		try {
			java.util.List<com.vportal.portlet.vadvman.model.AdvType> returnValue =
				AdvTypeServiceUtil.getTypeByG(groupId);

			return returnValue.toArray(new com.vportal.portlet.vadvman.model.AdvType[returnValue.size()]);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.vportal.portlet.vadvman.model.AdvType[] getTypeByG(
		...
		try {
			java.util.List<com.vportal.portlet.vadvman.model.AdvType> returnValue =
				AdvTypeServiceUtil.getTypeByG(groupId, start, end);
