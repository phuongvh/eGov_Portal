...
public class LinkGroupServiceClp implements LinkGroupService {
	public LinkGroupServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addLinkGroupMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"addLinkGroup", long.class, long.class, long.class,
				java.lang.String.class, java.lang.String.class, long.class,
				java.lang.Boolean.class, java.lang.Boolean.class,
				java.lang.String[].class, java.lang.String[].class);

		_updateLinkGroupMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateLinkGroup", long.class, long.class, long.class,
				java.lang.String.class, java.lang.String.class);

		_deleteLinkGroupMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteLinkGroup", long.class);

		_getAllMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
				"getAll");

		_getByGroupIdMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
				"getByGroupId", long.class);

		_getByGroupIdMethodKey6 = new MethodKey(_classLoaderProxy.getClassName(),
				"getByGroupId", long.class, int.class, int.class);

		_getLinkGroupMethodKey7 = new MethodKey(_classLoaderProxy.getClassName(),
				"getLinkGroup", long.class);

		_addLinkGroupResourcesMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"addLinkGroupResources", long.class, boolean.class,
				boolean.class);

		_addLinkGroupResourcesMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"addLinkGroupResources",
				com.vportal.portlet.vlinksman.model.LinkGroup.class,
				boolean.class, boolean.class);

		_addLinkGroupResourcesMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"addLinkGroupResources", long.class, java.lang.String[].class,
				java.lang.String[].class);

		_addLinkGroupResourcesMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"addLinkGroupResources",
				com.vportal.portlet.vlinksman.model.LinkGroup.class,
				java.lang.String[].class, java.lang.String[].class);
	}
	...
	public com.vportal.portlet.vlinksman.model.LinkGroup addLinkGroup(
		...
		MethodHandler methodHandler = new MethodHandler(_addLinkGroupMethodKey0,
				...
				ClpSerializer.translateInput(description), userId,
	...
	private MethodKey _addLinkGroupMethodKey1;
	private MethodKey _updateLinkGroupMethodKey2;
	private MethodKey _deleteLinkGroupMethodKey3;
	private MethodKey _getAllMethodKey4;
	private MethodKey _getByGroupIdMethodKey5;
	private MethodKey _getByGroupIdMethodKey6;
	private MethodKey _getLinkGroupMethodKey7;
	private MethodKey _addLinkGroupResourcesMethodKey8;
	private MethodKey _addLinkGroupResourcesMethodKey9;
	private MethodKey _addLinkGroupResourcesMethodKey10;
	private MethodKey _addLinkGroupResourcesMethodKey11;
}