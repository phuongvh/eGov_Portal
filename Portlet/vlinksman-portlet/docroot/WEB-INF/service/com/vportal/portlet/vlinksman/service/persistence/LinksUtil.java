	...
	*/
	...
	public static LinksPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LinksPersistence)PortletBeanLocatorUtil.locate(com.vportal.portlet.vlinksman.service.ClpSerializer.getServletContextName(),
					LinksPersistence.class.getName());

			ReferenceRegistry.registerReference(LinksUtil.class, "_persistence");
		}
