...
package com.vportal.portlet.vclip.service.messaging;
...
import com.vportal.portlet.vclip.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ClipLocalServiceUtil.clearService();

			ClipServiceUtil.clearService();
			ClipTypeLocalServiceUtil.clearService();

			ClipTypeServiceUtil.clearService();
		}
	}
}