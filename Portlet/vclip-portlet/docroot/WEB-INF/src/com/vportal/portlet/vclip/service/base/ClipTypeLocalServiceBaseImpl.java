...
public abstract class ClipTypeLocalServiceBaseImpl
	implements ClipTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public ClipType addClipType(ClipType clipType) throws SystemException {
		...
		clipType = clipTypePersistence.update(clipType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(clipType);
			}
	...
	public void deleteClipType(String id)
		...
		ClipType clipType = clipTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(clipType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public ClipType fetchClipType(String id) throws SystemException {
		return clipTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return clipTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public ClipType updateClipType(ClipType clipType) throws SystemException {
		return updateClipType(clipType, true);
	}
	...
	public ClipType updateClipType(ClipType clipType, boolean merge)
		...
		clipType = clipTypePersistence.update(clipType, merge);
	...
	/**
	 * Returns the clip remote service.
	 *
	...
	/**
	 * Returns the clip type remote service.
	 *
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vclip.model.ClipType",
			clipTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vclip.model.ClipType");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(ClipTypeLocalServiceBaseImpl.class);
