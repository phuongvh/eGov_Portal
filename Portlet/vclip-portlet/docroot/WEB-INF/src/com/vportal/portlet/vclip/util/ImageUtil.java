...
public class ImageUtil {
	 ...
	 */
	/*
	 * private static List findChildNodes(List tree, int parentId) { List
	 * childNodes = new ArrayList();
	 * 
	 * for (int i = 1; i < tree.size(); i++) { FAQCategory parent =
	 * (FAQCategory) tree.get(i); if (parent.getParent() == parentId) {
