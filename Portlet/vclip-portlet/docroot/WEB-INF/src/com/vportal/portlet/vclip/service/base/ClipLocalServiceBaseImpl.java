...
public abstract class ClipLocalServiceBaseImpl implements ClipLocalService,
	...
	public Clip addClip(Clip clip) throws SystemException {
		...
		clip = clipPersistence.update(clip, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(clip);
			}
	...
	public void deleteClip(String id) throws PortalException, SystemException {
		Clip clip = clipPersistence.remove(id);
	...
	public Clip fetchClip(String id) throws SystemException {
		return clipPersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return clipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Clip updateClip(Clip clip, boolean merge) throws SystemException {
		...
		clip = clipPersistence.update(clip, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.vclip.model.Clip",
			clipLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.vclip.model.Clip");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(ClipLocalServiceBaseImpl.class);
