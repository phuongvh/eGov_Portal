...
<div id="div_content">
		<table id="tb_content" style="border-style:none;">
			<tr id="tr_content">
				...
				<td align="center" style="width: 25%;">
					<span class="title_taive">S&#7889; &#273;i&#7879;n tho&#7841;i</span>
				</td>
		...
		%>
							<tr id="tr_content_01">
								...
								<td align="center" style="width: 25%"><div style="margin:7px;" align="left"><span class="coquanthuchien01"><%=employee.getHomePhone()%></span></div></td>
