 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.edirectory.service.impl.EDFunctionLocalServiceImpl}.
 * </p>
 *
 * @author HOAN
...
public abstract class EDFunctionLocalServiceBaseImpl
	implements EDFunctionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.edirectory.service.EDFunctionLocalServiceUtil} to access the e d function local service.
	 */
	...
	public EDFunction addEDFunction(EDFunction edFunction)
		...
		edFunction = edFunctionPersistence.update(edFunction, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(edFunction);
			}
	...
	public void deleteEDFunction(long id)
		...
		EDFunction edFunction = edFunctionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(edFunction);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public EDFunction fetchEDFunction(long id) throws SystemException {
		return edFunctionPersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return edFunctionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public EDFunction updateEDFunction(EDFunction edFunction)
		throws SystemException {
		return updateEDFunction(edFunction, true);
	}
	...
	public EDFunction updateEDFunction(EDFunction edFunction, boolean merge)
		...
		edFunction = edFunctionPersistence.update(edFunction, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.edirectory.model.EDFunction",
			edFunctionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.edirectory.model.EDFunction");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(EDFunctionLocalServiceBaseImpl.class);
