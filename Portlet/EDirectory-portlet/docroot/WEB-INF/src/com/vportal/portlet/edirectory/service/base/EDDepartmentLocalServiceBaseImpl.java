 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.edirectory.service.impl.EDDepartmentLocalServiceImpl}.
 * </p>
 *
 * @author HOAN
...
public abstract class EDDepartmentLocalServiceBaseImpl
	implements EDDepartmentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.edirectory.service.EDDepartmentLocalServiceUtil} to access the e d department local service.
	 */
	...
	public EDDepartment addEDDepartment(EDDepartment edDepartment)
		...
		edDepartment = edDepartmentPersistence.update(edDepartment, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(edDepartment);
			}
	...
	public void deleteEDDepartment(long id)
		...
		EDDepartment edDepartment = edDepartmentPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(edDepartment);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public EDDepartment fetchEDDepartment(long id) throws SystemException {
		return edDepartmentPersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return edDepartmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public EDDepartment updateEDDepartment(EDDepartment edDepartment)
		throws SystemException {
		return updateEDDepartment(edDepartment, true);
	}
	...
	public EDDepartment updateEDDepartment(EDDepartment edDepartment,
		...
		edDepartment = edDepartmentPersistence.update(edDepartment, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.edirectory.model.EDDepartment",
			edDepartmentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.edirectory.model.EDDepartment");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(EDDepartmentLocalServiceBaseImpl.class);
