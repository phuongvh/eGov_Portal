 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.edirectory.service.impl.EDFunctionDepartmentLocalServiceImpl}.
 * </p>
 *
 * @author HOAN
...
public abstract class EDFunctionDepartmentLocalServiceBaseImpl
	implements EDFunctionDepartmentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.edirectory.service.EDFunctionDepartmentLocalServiceUtil} to access the e d function department local service.
	 */
	...
	public EDFunctionDepartment addEDFunctionDepartment(
		...
		edFunctionDepartment = edFunctionDepartmentPersistence.update(edFunctionDepartment,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(edFunctionDepartment);
			}
	...
	public void deleteEDFunctionDepartment(long id)
		...
		EDFunctionDepartment edFunctionDepartment = edFunctionDepartmentPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(edFunctionDepartment);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public EDFunctionDepartment fetchEDFunctionDepartment(long id)
		throws SystemException {
		return edFunctionDepartmentPersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return edFunctionDepartmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public EDFunctionDepartment updateEDFunctionDepartment(
		EDFunctionDepartment edFunctionDepartment) throws SystemException {
		return updateEDFunctionDepartment(edFunctionDepartment, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.edirectory.model.EDFunctionDepartment",
			edFunctionDepartmentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.edirectory.model.EDFunctionDepartment");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(EDFunctionDepartmentLocalServiceBaseImpl.class);
