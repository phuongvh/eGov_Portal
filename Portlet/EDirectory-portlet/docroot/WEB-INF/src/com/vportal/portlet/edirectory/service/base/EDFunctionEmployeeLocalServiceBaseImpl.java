 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.edirectory.service.impl.EDFunctionEmployeeLocalServiceImpl}.
 * </p>
 *
 * @author HOAN
...
public abstract class EDFunctionEmployeeLocalServiceBaseImpl
	implements EDFunctionEmployeeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.edirectory.service.EDFunctionEmployeeLocalServiceUtil} to access the e d function employee local service.
	 */
	...
	public EDFunctionEmployee addEDFunctionEmployee(
		...
		edFunctionEmployee = edFunctionEmployeePersistence.update(edFunctionEmployee,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(edFunctionEmployee);
			}
	...
	public void deleteEDFunctionEmployee(long id)
		...
		EDFunctionEmployee edFunctionEmployee = edFunctionEmployeePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(edFunctionEmployee);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public EDFunctionEmployee fetchEDFunctionEmployee(long id)
		throws SystemException {
		return edFunctionEmployeePersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return edFunctionEmployeePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public EDFunctionEmployee updateEDFunctionEmployee(
		EDFunctionEmployee edFunctionEmployee) throws SystemException {
		return updateEDFunctionEmployee(edFunctionEmployee, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.edirectory.model.EDFunctionEmployee",
			edFunctionEmployeeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.edirectory.model.EDFunctionEmployee");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(EDFunctionEmployeeLocalServiceBaseImpl.class);
