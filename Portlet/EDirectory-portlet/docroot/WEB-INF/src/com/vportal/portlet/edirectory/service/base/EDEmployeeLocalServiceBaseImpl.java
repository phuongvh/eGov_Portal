 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.edirectory.service.impl.EDEmployeeLocalServiceImpl}.
 * </p>
 *
 * @author HOAN
...
public abstract class EDEmployeeLocalServiceBaseImpl
	implements EDEmployeeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.edirectory.service.EDEmployeeLocalServiceUtil} to access the e d employee local service.
	 */
	...
	public EDEmployee addEDEmployee(EDEmployee edEmployee)
		...
		edEmployee = edEmployeePersistence.update(edEmployee, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(edEmployee);
			}
	...
	public void deleteEDEmployee(long id)
		...
		EDEmployee edEmployee = edEmployeePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(edEmployee);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public EDEmployee fetchEDEmployee(long id) throws SystemException {
		return edEmployeePersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return edEmployeePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public EDEmployee updateEDEmployee(EDEmployee edEmployee)
		throws SystemException {
		return updateEDEmployee(edEmployee, true);
	}
	...
	public EDEmployee updateEDEmployee(EDEmployee edEmployee, boolean merge)
		...
		edEmployee = edEmployeePersistence.update(edEmployee, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.vportal.portlet.edirectory.model.EDEmployee",
			edEmployeeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vportal.portlet.edirectory.model.EDEmployee");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(EDEmployeeLocalServiceBaseImpl.class);
