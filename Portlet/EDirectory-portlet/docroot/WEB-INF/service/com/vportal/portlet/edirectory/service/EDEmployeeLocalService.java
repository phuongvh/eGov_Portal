...
/**
 * The interface for the e d employee local service.
 *
 * <p>
 ...
 *
 * @author HOAN
 * @see EDEmployeeLocalServiceUtil
...
public interface EDEmployeeLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EDEmployeeLocalServiceUtil} to access the e d employee local service. Add custom service methods to {@link com.vportal.portlet.edirectory.service.impl.EDEmployeeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	/**
	* Danh sÃ¡ch cÃ¡n bá»™ theo Ä‘Æ¡n vá»‹
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* TÃ¬m cÃ¡n bá»™ theo id vÃ  Ä‘Æ¡n vá»‹
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* Danh sÃ¡ch cÃ¡n bá»™ theo chá»©c vá»¥
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* Danh sÃ¡ch cÃ¡n bá»™ theo Ä‘Æ¡n vá»‹ vÃ  chá»©c vá»¥
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* Danh sÃ¡ch cÃ¡n bá»™ theo há»� tÃªn
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* Danh sÃ¡ch cÃ¡n bá»™ theo há»� tÃªn vÃ  Ä‘Æ¡n vá»‹
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* Danh sÃ¡ch cÃ¡n bá»™ theo Há»� tÃªn vÃ  Chá»©c vá»¥
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	/**
	* Tim kiem can bo cua nguoi dan Danh sÃ¡ch cÃ¡n bá»™ theo Há»� tÃªn, Ä�Æ¡n vá»‹ vÃ 
	* Chá»©c vá»¥
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	...
	*/
	...
	/**
	* ThÃªm cÃ¡c chá»©c vá»¥ cá»§a má»™t cÃ¡n bá»™
	*/
